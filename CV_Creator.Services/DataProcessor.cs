...
namespace CV_Creator.Services
{
    public class DataProcessor : IDataProcessor
    {
        ...
        {
            return new FooterSettings() { FontSize = 9, LeftText = "Aplication for " + companyName.ToUpper() + " genereted by: github.com/przemyslawbak/CV_Creator", RightText = "Przemyslaw Bak - Page [page] of [toPage]", UseLineSeparator = true };
        }
