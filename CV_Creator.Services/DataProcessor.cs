...
namespace CV_Creator.Services
{
    public class DataProcessor : IDataProcessor
    {
        ...
        {
            return new FooterSettings() { FontSize = 9, LeftText = "Generated with: github.com/przemyslawbak/CV_Creator", RightText = "Przemyslaw Bak - Page [page] of [toPage]", UseLineSeparator = true };
        }
